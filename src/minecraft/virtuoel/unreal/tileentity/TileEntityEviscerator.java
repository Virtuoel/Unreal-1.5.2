package virtuoel.unreal.tileentity;
...
public class TileEntityEviscerator extends TileEntity implements ISidedInventory, net.minecraftforge.common.ISidedInventory
{
    ...
    public void smeltItem()
    {
        if (this.canSmelt())
        {
            ItemStack itemstack = EviscerateRecipes.grinding().getGrindingResult(this.furnaceItemStacks[0]);
