...
public class ModLavaBoat extends Item
{
    public ModLavaBoat(int par1)
    {
        super(par1);
        this.maxStackSize = 1;
        ...
        else
        {
            ...
            else
            {
                if (movingobjectposition.typeOfHit == EnumMovingObjectType.TILE)
                {
                    ...
                    EntityLavaBoat entityboat = new EntityLavaBoat(par2World, (double)((float)i + 0.5F), (double)((float)j + 1.0F), (double)((float)k + 0.5F));
