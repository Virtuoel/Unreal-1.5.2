...
public class ModAsbestosSuit extends ItemArmor{

	public ModAsbestosSuit(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4) {
    ...
    {
        return MainMod.allItems.bucketMercury.itemID == par2ItemStack.itemID ? true :
        MainMod.allItems.blockAsbestos.blockID == par2ItemStack.itemID ? true : false;
    }
    ...
    public void onArmorTickUpdate(World par1World, EntityPlayer par2EntityPlayer, ItemStack par3ItemStack){
    	if(par3ItemStack.itemID==this.itemID&&par3ItemStack.getItemDamage()<par3ItemStack.getMaxDamage()){
    		...
    		if(par2EntityPlayer.getActivePotionEffect(Potion.fireResistance).duration<4){
