...
public class EntityLavaBoat extends Entity
{
    ...
    public boolean attackEntityFrom(DamageSource par1DamageSource, int par2)
    {
        ...
        else if (!this.worldObj.isRemote && !this.isDead)
        {
            ...
            if (flag || this.getDamageTaken() > 40)
            {
                ...
                if (!flag)
                {
                    this.dropItemWithOffset(MainMod.allItems.boatLava.itemID, 1, 0.0F);
                }
    ...
    public void onUpdate()
    {
        ...
        if(this.riddenByEntity instanceof EntityLiving){
        	//Fire resist
        	//((EntityLiving)(this.riddenByEntity)).addPotionEffect(new PotionEffect(i, 21, 1));
        }
        ...
        else
        {
            ...
            if (this.isCollidedHorizontally && d3 > 0.2D)
            {
                if (!this.worldObj.isRemote && !this.isDead)
                {
                    ...
                    for (k = 0; k < 2; ++k)
                    {
                        this.dropItemWithOffset(MainMod.allItems.nuggetIron.itemID, 1, 0.0F);
                    }
                }
            }
            else
