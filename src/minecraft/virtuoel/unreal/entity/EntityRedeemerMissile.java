...
public class EntityRedeemerMissile extends EntityThrowable
{
	public float explosionRadius = 10.0F;

	public EntityRedeemerMissile(World par1World)
	{
		super(par1World);
	}

	public EntityRedeemerMissile(World par1World, EntityLiving par2EntityLiving)
	{
	...
	public EntityRedeemerMissile(World par1World, double par2, double par4, double par6)
	{
	...
	public String getEntityName()
	{
		if(this.getShellThrower()!=null){
			if(this.getShellThrower().getEntityName().substring(this.getShellThrower().getEntityName().length()-1).toLowerCase().equals('s')){
				return this.getShellThrower().getEntityName() + "' Redeemer";
			}else{
				return this.getShellThrower().getEntityName() + "'s Redeemer";
			}
		}
		return "a Nuclear Warhead";
	}
	...
	protected void onImpact(MovingObjectPosition par1MovingObjectPosition)
	{
		...
		{
			this.worldObj.newExplosion(this, this.posX, this.posY, this.posZ, (float)this.explosionRadius, true, false);
