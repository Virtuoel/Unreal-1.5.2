...
public class ModCactusTarydium extends ModBasicBlock implements IPlantable
{
    ...
    public ModCactusTarydium(int par1)
    {
        super(par1, ModMaterial.tarydium);
    ...
    {
        this.blockIcon = par1IconRegister.registerIcon(MainMod.modName+":"+"cactus_taryd_side");
        this.cactusTopIcon = par1IconRegister.registerIcon(MainMod.modName+":"+"cactus_taryd_top");
        this.cactusBottomIcon = par1IconRegister.registerIcon(MainMod.modName+":"+"cactus_taryd_bottom");
    }
	...
	public void onBlockHarvested(World par1World, int par2, int par3, int par4, int par5, EntityPlayer par6EntityPlayer) {
		par6EntityPlayer.attackEntityFrom(DamageSource.cactus, 4);
	}
